...
点击下方链接查看完整的 Tableau 交互式仪表盘：

[电商销售数据分析仪表盘](https://public.tableau.com/views/ecommerce_sales_17809225161720/1?:language=zh-CN&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
